<%-- 
    Document   : InsertarUnidadBodeguero
    Created on : 12/03/2020, 08:36:36 PM
    Author     : srami
--%>
     ...
     <%
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                   <li><a href="ListarUnidadesBodeguero.jsp">Lista Unidades</a></li>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form name="ingreso" action="IngresoUnidadBodeguero" method="post" autocomplete="off">
                    <div class="row">
