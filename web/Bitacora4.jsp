...
<body>
  ...
  <%
         ...
         ArrayList<Bitacora> la_var = lo_devolucionesService.listaBitacora();
  ...
  <input style="width: 25%; margin-left: 10px" id="searchTerm" onkeyup="doSearch()" class="form-control" type="text" placeholder="Buscar" aria-label="Search">
       ...
       <div class="table-responsive">
                                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        <thead>
                                            <tr class="success">
                                                <th class="text-center th-sm">Fecha de Accion</th>
                                                <th class="text-center th-sm">Nombre</th>
                                                <th class="text-center th-sm">Responsable</th>
