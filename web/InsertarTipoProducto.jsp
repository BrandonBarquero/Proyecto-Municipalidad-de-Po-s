       ...
       <jsp:include page="Header.jsp"/>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para insertar el tipo de producto
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                   <li><a href="ListarTipoProducto.jsp">Lista tipo de productos</a></li>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form name="ingreso" action="IngresoTipoProducto" method="post" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">

                               <div class="group-material">
                                   <input name="nombre" type="text" class="material-control tooltips-general" placeholder="Tipo de Producto" required="" maxlength="70" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s 0-9]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe el tipo de producto">
