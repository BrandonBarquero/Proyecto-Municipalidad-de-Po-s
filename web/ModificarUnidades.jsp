<%-- 
    Document   : ModificarUnidades
    Created on : 12/03/2020, 08:38:16 PM
    Author     : srami
--%>
     ...
     <%
         ...
         <!--Inicio Cuerpo PÃ¡gina-->
            ...
            <div class="page-header">
              <h1 class="all-tittles">SIM<small> Modificar Unidades </small></h1>
            </div>
        </div>
 <%
          String ln_id=request.getParameter("Id_Unidad");
          UnidadService lo_unidadService = new UnidadService();
          ArrayList<Unidad> lu_var = lo_unidadService.listaUnidadFiltrado(ln_id);
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form name="modificarr" action="ModificarUnidades" autocomplete="off">
                    <div class="row">
