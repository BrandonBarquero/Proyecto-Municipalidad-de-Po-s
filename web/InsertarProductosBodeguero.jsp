<%-- 
    Document   : InsertarProductosBodeguero
    Created on : 18/03/2020, 03:48:48 PM
    Author     : srami
--%>
...
<body>
    <%
        ...
        String la_UsuarioNombre = (String) session.getAttribute("user6");
       ...
       %>
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
             ...
             <!-- <li role="presentation"><a href="ListarTipoProductoBodeguro.jsp">Tipos de Productos</a></li> -->
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <form name="ingreso" action="IngresoProductoBodeguero" method="post" autocomplete="off" onsubmit="return validarFecha('Garantia','Fecha')">
