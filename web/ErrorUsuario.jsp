<%-- 
    ...
    Created on : 20-feb-2020, 11:42:16
    Author     : barqu
--%>
...
<div class="container-fluid"  style="margin: 50px 0;">
         ...
         <h3 style="text-align: center; color: red; "> Error al ingresar usuario, por favor verifique que los datos ingresados sean correctos y que la cédula no exista ya en el programa </h3>
