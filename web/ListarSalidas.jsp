...
<br>
                     ...
                     <td><%=lu_rs.getString("Codigo_Producto")%> </td>
                      <td><%=lu_rs.getString("Descripcion")%> </td>
                                                ...
                                                <td><a href="Devolucion.jsp?Cantidad=<%=lu_rs.getString("cantidad")%>&Codigo_Producto=<%=lu_rs.getString("Codigo_Producto")%>"> <button type="submit" class="btn btn-info tooltips-general" data-toggle="tooltip" data-placement="top" title=""><i class="zmdi zmdi-time-restore"></i></button></td>
                                            </tr>
                                                                   <!--TR EXTRA-->                                  
