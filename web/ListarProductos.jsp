                                    ...
                                    <table id="datos" class="table table-hover text-center">
                                        ...
                                        <tbody>
                                            <tr><%    while(rs.next()){   %>
                                                ...
                                                <td> <a href="RetirarProducto.jsp?Cantidad=<%=rs.getString("cantidad")%>&Codigo_Producto=<%=rs.getString("Codigo_Producto")%>" /> <button type="submit" class="btn btn-warning tooltips-general" data-toggle="tooltip" data-placement="top" title=""><i class="zmdi zmdi-swap"></i></button></td>
                                                <td> <a href="Devolucion.jsp?Cantidad=<%=rs.getString("cantidad")%>&Codigo_Producto=<%=rs.getString("Codigo_Producto")%>" /> <button type="submit" class="btn btn-primary tooltips-general" data-toggle="tooltip" data-placement="top" title=""><i class="zmdi zmdi-time-restore"></i></button></td>
                                            </tr>
