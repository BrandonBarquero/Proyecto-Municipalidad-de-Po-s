 ...
 * @author Allan
 */
@WebServlet(name = "ModificarBodegas", urlPatterns = {"/ModificarBodegas"})
public class ModificarBodegas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ModificarBodegas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
