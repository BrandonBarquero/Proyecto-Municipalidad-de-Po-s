 ...
 * @author Allan
 */
@WebServlet(name = "ModificarBodegasBodeguero", urlPatterns = {"/ModificarBodegasBodeguero"})
public class ModificarBodegasBodeguero extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ModificarBodegasBodeguero.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
