 ...
 * @author Allan
 */
@WebServlet(name = "ModificarTipoProductoBodeguero", urlPatterns = {"/ModificarTipoProductoBodeguero"})
public class ModificarTipoProductoBodeguero extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ModificarTipoProductoBodeguero.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
