 ...
 * @author srami
 */
@WebServlet(name = "IngresoProductoBodeguero", urlPatterns = {"/IngresoProductoBodeguero"})
public class IngresoProductoBodeguero extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(IngresoProductoBodeguero.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
